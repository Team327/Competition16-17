...
public abstract class Constants {
    //Defined by Team 327
    public static final int EXPO_COMP = -6; //Default for the robotics lab
    ...
    public static final ColorHSV COLOR_RED_LOWER = new ColorHSV((int) (320.0 / 360.0 * 255.0), (int) (0.180 * 255.0), (int) (0.500 * 255.0));
    public static final ColorHSV COLOR_RED_UPPER = new ColorHSV((int) (375.0 / 360.0 * 255.0), (int) (0.500 * 255.0), (int) (1.000 * 255.0));
    public static final ColorHSV COLOR_BLUE_LOWER = new ColorHSV((int) (170.0 / 360.0 * 255.0), (int) (0.300 * 255.0), (int) (0.850 * 255.0));
    public static final ColorHSV COLOR_BLUE_UPPER = new ColorHSV((int) (230.0 / 360.0 * 255.0), (int) (1.000 * 255.0), (int) (1.000 * 255));
    //FAST
